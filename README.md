...
- Build the following features on your website:
    ...
    - A user should be able to see a list of all scientists #DONE

    - Clicking on a scientist should take you to a detail page about the scientist. This detail page should list all the planets they have visited and the name of the mission that took them there. #DONE

    - A user should be able to create a new scientist. #DONE
    ...
    - A user should be able to edit the details of a scientist #DONE

    - A user should be able to delete a scientist #DONE

    - A user should be able to create a new mission by choosing a scientist and a planet from dropdown menus. #DONE
